  ...
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        side === "bottom" &&
          "inset-x-0 bottom-0 rounded-t-2xl border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom max-h-[92dvh] overflow-y-auto",
        side === "top" &&
    ...
    >
      ...
      {side === "bottom" && (
        <div className="sticky top-0 z-10 bg-background pt-3 pb-1 flex justify-center">
...
const SheetFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-col-reverse sm:flex-row sm:justify-end gap-2 px-4 pb-6 pt-2", className)} {...props} />
)
