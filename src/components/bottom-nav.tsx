...
import { Package, ScanLine, ChefHat, ShoppingCart, BookOpen } from "lucide-react"
...
export function BottomNav() {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 right-0 z-50 bg-background border-t border-border pb-safe safe-bottom"
    >
